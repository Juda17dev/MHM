<form class="form-horizontal" method="POST" action="{{ $action }}">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" placeholder="Non du visiteur" value="{{ old('nom', $visiteur->nom) }}">
                @error('nom')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="prenom" class="form-control @error('prenom') is-invalid @enderror" placeholder="Prenom du visiteur" value="{{ old('prenom', $visiteur->prenom) }}">
                @error('prenom')
                    <span class="error invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="file" accept=".jpg,.jpeg,.png" name="identite" class="form-control @error('indentite') is-invalid @enderror" placeholder="Identite du visiteur" value="{{ old('identite', $visiteur->identite) }}">
                @error('indentite')
                    <span class="error invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
